...
func RegisterFlags(flags *pflag.FlagSet) {
	defaults := Default()
	flags.String(FlagName(KeyFormattingPreset), defaults.Formatting.Preset, "Sets a starting style before individual settings are applied")
	...
	flags.String(FlagName(KeyFormattingYAMLQuoteStyle), defaults.Formatting.YAML.QuoteStyle, "Chooses a quote style where the value can stay unchanged")
	...
	flags.String(FlagName(KeyFormattingTOMLQuoteStyle), defaults.Formatting.TOML.QuoteStyle, "Chooses a quote style where the string can stay unchanged")
