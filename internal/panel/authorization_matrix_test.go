...
func TestPanelRootRouteAuthorizationMatrix(t *testing.T) {
	...
	probes := []authorizationProbe{
		...
		{http.MethodGet, "/panel/api/v1/root/workspaces/github:installation:10/deliveries/1/recovery"},
		{http.MethodPost, "/panel/api/v1/root/workspaces/github:installation:10/deliveries/1/recovery"},
		...
		{http.MethodGet, "/panel/api/v1/root/workspaces/" + target + "/bypass-actors"},
...
func regularRouteProbes(target string) []authorizationProbe {
	...
	return []authorizationProbe{
		...
		{http.MethodGet, target + "/bypass-actors"},
		...
		{http.MethodGet, target + "/sync/requests/check/request"},
		{http.MethodGet, target + "/sync/checks/check-1"},
		...
		{http.MethodGet, target + "/deliveries/1/recovery"},
		{http.MethodPost, target + "/deliveries/1/recovery"},
