...
const PAGES: ReadonlyArray<readonly [view: string, route: string]> = [
  ...
  ['queue', 'i/queue'],
  ['labels', 'i/sync/labels'],
  ['settings', 'i/sync/settings'],
  ['rulesets', 'i/sync/rulesets'],
  ['files', 'i/sync/files'],
  ['plan', 'i/sync/plan'],
  ['users', 'i/access/users'],
  ['invitations', 'i/access/invitations'],
  ['audit', 'i/history/audit'],
  ['failures', 'i/history/failures'],
  ['ws-settings', 'i/settings'],
  ['inbox', 'inbox'],
];
