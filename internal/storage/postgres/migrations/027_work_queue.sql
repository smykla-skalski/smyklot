-- Shared background-work queue. SQLite twin: 042_work_queue.sql.
...
CREATE TABLE schedule_exceptions (
    ...
    CHECK ((closed AND start_minute = 0 AND end_minute = 0)
        OR (NOT closed AND start_minute < end_minute))
);
...
CREATE TABLE queue_policies (
    ...
    retry_delay_seconds BIGINT NOT NULL CHECK (retry_delay_seconds >= 0),
    retention_seconds BIGINT CHECK (retention_seconds >= 0),
    approval_ttl_seconds BIGINT CHECK (approval_ttl_seconds > 0),
...
INSERT INTO schedule_profiles (
    ...
    'always-open', 'Always Open', 'UTC', TRUE, 1,
...
INSERT INTO queue_policies (
    ...
    ('webhook_delivery', 'root', TRUE, 0, 'always-open', 'urgent', 2, 2592000, NULL, '{"max_delay_seconds":300,"max_attempts":8}', '1970-01-01T00:00:00.000000000Z'),
    ('pending_ci', 'root', TRUE, 300, 'always-open', 'normal', 5, NULL, NULL, '{"active_check_seconds":300,"no_check_grace_seconds":600,"defer_after_seconds":3600,"deferred_check_seconds":21600,"passing_quiet_seconds":30}', '1970-01-01T00:00:00.000000000Z'),
    ('pending_ci_gate', 'root', TRUE, 300, 'always-open', 'normal', 30, NULL, NULL, '{}', '1970-01-01T00:00:00.000000000Z'),
    ('catalog_refresh', 'root', TRUE, 300, 'always-open', 'normal', 30, NULL, NULL, '{}', '1970-01-01T00:00:00.000000000Z'),
    ('reaction_scan', 'root', TRUE, 300, 'always-open', 'normal', 30, NULL, NULL, '{}', '1970-01-01T00:00:00.000000000Z'),
    ('config_migration', 'root', TRUE, 300, 'always-open', 'normal', 30, NULL, NULL, '{}', '1970-01-01T00:00:00.000000000Z'),
    ('sync_scan', 'root', TRUE, 21600, 'always-open', 'normal', 300, NULL, 7200, '{}', '1970-01-01T00:00:00.000000000Z'),
    ('sync_apply', 'root', TRUE, 0, 'always-open', 'normal', 300, NULL, NULL, '{}', '1970-01-01T00:00:00.000000000Z'),
    ('path_refresh', 'root', TRUE, 3600, 'always-open', 'low', 300, NULL, NULL, '{}', '1970-01-01T00:00:00.000000000Z'),
    ('delivery_cleanup', 'root', TRUE, 300, 'always-open', 'low', 300, 2592000, NULL, '{}', '1970-01-01T00:00:00.000000000Z'),
    ('auth_cleanup', 'root', TRUE, 300, 'always-open', 'low', 300, NULL, NULL, '{}', '1970-01-01T00:00:00.000000000Z');
...
SELECT
    ...
    'urgent', 'bypass', FALSE, COALESCE(next_attempt_at, claimed_at),
...
SELECT
    ...
    CASE WHEN cleanup_pending THEN 'retrying'
    ...
    'normal', 'respect', FALSE, 'always-open', next_check_at, next_check_at,
    cleanup_attempts, requested_at, updated_at,
    CASE WHEN cleanup_pending THEN NULL ELSE finished_at END
...
SELECT
    ...
    'normal', 'respect', FALSE, 'always-open', COALESCE(approved_at, computed_at),
