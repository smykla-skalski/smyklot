-- Restorable installation sync configuration. The SQLite twin is
-- 038_sync_config_history.sql, and TestSchemaParity fails if they drift.
...
CREATE TABLE sync_config_checkpoints (
    ...
    restored_from_id BIGINT REFERENCES sync_config_checkpoints(id) ON DELETE SET NULL,
...
ALTER TABLE audit_entries
    ADD COLUMN sync_config_checkpoint_id BIGINT
