-- Sparse, immutable checkpoints for the bounded settings resources. The SQLite
-- twin is 039_settings_checkpoints.sql, and TestSchemaParity fails if they drift.
-- Legacy Sync checkpoints remain unchanged for compatibility.
...
ALTER TABLE audit_entries
    ADD COLUMN settings_checkpoint_id BIGINT
